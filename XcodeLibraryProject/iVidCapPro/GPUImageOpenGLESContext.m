...
EAGLContext* ivcp_UnityGetContext();
...
- (id)init;
{
    ...
    // eOe
    _contextQueue = dispatch_queue_create("com.eccentric-orbits.GPUImage.openGLESContextQueue", NULL);
...
{
    //NSLog(@"GPUImageOpenGLESContext: useImageProcessingContext called...\n");
...
- (EAGLContext *)context;
{
    //NSLog(@"GPUImageOpenGLESContext: context called...\n");
    ...
    if (_context == nil)
    {
        ...
        _context = [[EAGLContext alloc] initWithAPI:[unity_context API] sharegroup: [unity_context sharegroup]];
